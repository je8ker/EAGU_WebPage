...
import EditAbout from 'frontend/src/pages/edit/edit-about.vue'; // edit-about-test.vue 파일 경로에 맞게 import
import EditActivities from 'frontend/src/pages/edit/edit-activities.vue';
import EditBenefits from 'frontend/src/pages/edit/edit-benefits.vue';
import EditGallery from 'frontend/src/pages/edit/edit-gallery.vue';
import EditMembers from 'frontend/src/pages/edit/edit-members.vue';
import EditNotice from 'frontend/src/pages/edit/edit-notice.vue';
